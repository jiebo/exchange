...
CREATE TABLE config_city (
    city_name VARCHAR(10) CHARACTER SET utf8,
    days NUMERIC(2, 1),
    nights NUMERIC(2, 1),
    currency CHAR(3) CHARACTER SET utf8
);
INSERT INTO config_city VALUES ('Iceland',3,4,'ISK');
INSERT INTO config_city VALUES ('London',5.5,6,'GBP');
...
INSERT INTO config_city VALUES ('Rome',2.5,3,'EUR');
...
INSERT INTO config_city VALUES ('Paris',3,3,'EUR');
